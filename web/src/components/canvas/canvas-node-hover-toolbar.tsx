...
import { Download, Ellipsis, FolderPlus, Image as ImageIcon, ImagePlus, Info, MessageSquare, Minus, Music2, Pencil, Plus, RefreshCw, Settings2, Trash2, Upload, Video } from "lucide-react";
...
export function CanvasNodeHoverToolbar({
    ...
    const nodeToolbarTools: ToolbarTool[] = [
        ...
        ...(isGroup ? [{ id: "addGroupFiles", title: t("canvas.elementGroup.addFiles"), label: t("canvas.elementGroup.addFiles"), icon: <ImagePlus className="size-4" />, onClick: () => onUpload(node) }] : []),
